...
def ssh_student(setup_script=None, memory_limit=0, hard_time_limit=0, time_limit=0, environment_type=None, container=None, run_as_root=False, teardown_script=None):
    """
    ...
    :param environment_type: environment type to use. By default it is None, meaning the current container type will be used.
